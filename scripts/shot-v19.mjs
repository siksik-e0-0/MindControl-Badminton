// v1.9 확인: 출처🔻 요약, 단식 서브 측·리시브 측 '추천 코스' 자동 재생(3구까지), 다른 주제에서 버튼 숨김, 재생 중 '처음'으로 취소. 사용: node scripts/shot-v19.mjs
import { chromium } from "playwright-core";
import { mkdirSync } from "node:fs";
import { homedir } from "node:os";
import { join } from "node:path";
const outDir = "/tmp/v19"; mkdirSync(outDir, { recursive: true });
